...
cuobjdump: build
	@cuobjdump -arch sm_80 -sass -fun $(FUNCTION) build/sgemm | c++filt > build/cuobjdump.sass
	@cuobjdump -arch sm_80 -ptx -fun $(FUNCTION) build/sgemm | c++filt > build/cuobjdump.ptx
